...
public class _Optional {
	...
	public static void main(String[] args) {
		...
		final String orElse = hello3.map(statement -> statement.toUpperCase())
				// .map(String::toUpperCase)---> Another way of writing map(statement ->
		...
		final String orElseGet = hello4.map(statement -> statement.toUpperCase())
				// .map(String::toUpperCase)---> Another way of writing map(statement ->
				// statement.toUpperCase())
				.orElseGet(() -> {
